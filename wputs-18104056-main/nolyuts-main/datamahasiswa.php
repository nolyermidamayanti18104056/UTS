        ...
        switch ($act){
            case "store":
                ...
                if($pass1 == $pass2){
                    ...
                    $sql = "INSERT INTO tbmhs(nama, nim, alamat, jk, prodi, jurusan) VALUES('$nama', '$nim', '$alamat', '$jk', '$prodi', '$jurusan');";
            ...
            case "update":
                ...
                if($pass1 == $pass2){
                  ...
                  $prodi = $_POST["txPRODI"];
                  $jurusan = $_POST["txJURUSAN"];
                    $sql = "UPDATE tbmhs SET nama='$nama', alamat='$alamat', jk='$jk', prodi='$prodi', jurusan='$jurusan' WHERE nim='$nim';";
                    $hasil = mysqli_query($cnn, $sql);
                    if($hasil){
                        $footer = "<script>
                        Swal.fire({
            ...
            case "destroy":
                $nim = $_POST['txNIM'];
                $sql = "DELETE FROM tbmhs WHERE nim='$nim';";
                $hasil = mysqli_query($cnn, $sql);
                    if($hasil){
                        $footer = "<script>
                        Swal.fire({
